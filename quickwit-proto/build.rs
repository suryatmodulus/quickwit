...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("cargo:rerun-if-changed=proto/index_api.proto");
    println!("cargo:rerun-if-changed=proto/ingest_api.proto");
    println!("cargo:rerun-if-changed=proto/quicklet_api.proto");
    ...
    tonic_build::configure()
        ...
        .compile_with_config(
            ...
            &[
                ...
                "./proto/index_api.proto",
                "./proto/ingest_api.proto",
                "./proto/quicklet_api.proto",
            ],
            &["./proto"],
        )?;
    Ok(())
